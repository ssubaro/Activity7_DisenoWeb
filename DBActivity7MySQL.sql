...
CREATE TABLE `courses` (
  ...
  `robotics_kit_id` bigint unsigned NOT NULL,
  `teacher_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `courses_course_key_unique` (`course_key`),
  KEY `courses_robotics_kit_id_foreign` (`robotics_kit_id`),
  KEY `courses_teacher_id_foreign` (`teacher_id`),
  CONSTRAINT `courses_robotics_kit_id_foreign` FOREIGN KEY (`robotics_kit_id`) REFERENCES `robotics_kits` (`id`),
...
CREATE TABLE `groups` (
  ...
  `level` enum('principiante','intermedio','avanzado') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'2025_03_08_055137_create_robotics_kits_table',1),(3,'2025_03_08_055138_create_admins_table',1),(4,'2025_03_08_055138_create_groups_table',1),(5,'2025_03_08_055138_create_teachers_table',1),(6,'2025_03_08_055139_create_courses_table',1),(7,'2025_03_08_055139_create_students_table',1),(8,'2025_03_08_055140_create_contents_table',1),(9,'2025_03_08_055140_create_didactic_materials_table',1),(10,'2025_03_08_055142_create_course_group_table',1);
...
CREATE TABLE `robotics_kits` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `robotics_kits_name_unique` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-08  0:23:34
